export function encodePcmToWav16kMono(samples: Float32Array): ArrayBuffer {
...
export function downsamplePcmTo16kMono(channels: Float32Array[], sampleRate: number): Float32Array {
